...
class ChatBotApp:
    ...
    def display_chat_history(self, response: dict) -> None:
        ...
        creating pairs of consecutive messages. If there is an odd number of messages in the chat history, the last message is ignored.
        ...
        and the bot message (if it exists) using the `bot_template`. The `unsafe_allow_html=True` argument is used to allow HTML tags
        in the messages.
        """
    ...
    def run_app(self) -> None:
        ...
        It then writes the CSS to the Streamlit session and displays the header "Chat with PDFs knowledge base :books:".
        ...
        The response is then passed to the `display_chat_history` method to display the chat history.
